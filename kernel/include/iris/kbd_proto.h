 ...
 * (Phase 13/Track G).  The live keyboard service is endpoint + notification
 * only: requests over "kbd.ep" and IRQ1 delivery over a KNotification
 * (iris/kbd_ep_proto.h).  IRQ routing was moved off KChannel in Phase 7.6.
 *
 ...
 *     HISTORICAL (retired in Phase 7.6): IRQ1 was delivered as this KChannel
...
/* ── IRQ channel message (HISTORICAL for kbd — retired in Phase 7.6) ──────
 ...
 * Phase 7.6 and the kbd server does not dispatch this type anymore.   */
...
/* ── C-only helpers ─────────────────────────────────────────────────────── */
/* Phase 13/Track G: the KChanMsg-based kbd_proto_* inline helpers (HELLO/
