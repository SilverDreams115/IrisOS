...
- **Runtime tests** — booted under QEMU headless: **302 tests** covering IPC and
...
ENABLE_RUNTIME_SELFTESTS=1 make smoke-runtime-selftests    # + full self-test suite (302/302)
